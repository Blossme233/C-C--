...
// TODO: Complete this function, so that it can be used in the isBridge
// function
void Graph::removeEdge(int key1, int key2) {
    ...
    // Ex: say you need to remove ith index item from a vector "myvector", you
    // can use myvector.erase(myvector.begin()+i)
}
...
bool Graph::isBridge(int key1, int key2) {
    ...
    cout << "num. of connected components before removal: "
         << initial_components << endl;
    ...
    // num. of connected componenets in the modified graph (i.e after removing
    // the edge)
